...
var FAKE_FAN = {
  ...
  setPowerOn: function(on) {
    ...
    io.sendMessage({ "name" : "homekit_fan_power","value" : FAKE_FAN.powerOn});
    /*
	 旧的使用方法现在使用websocket的
    request($conf.configuration.url + '',{
	   form: {
	     name: "homekit_fan_power",
	     value: FAKE_FAN.powerOn
	  	},
	   json: true
	 }, 
  ...
  setSpeed: function(value) {
    ...
    io.sendMessage({ "name" : "homekit_fan_rSpeed","value" : FAKE_FAN.rSpeed});
    /*
    request($conf.configuration.url + '',{
	   form: {
	     name: "homekit_fan_rSpeed",
	     value: FAKE_FAN.rSpeed
	  	},
	   json: true
	 }, 
	 function (error, response, body) {
